...
what_is_on_intent = {
    ...
    u'fulfillmentActivity': {u'codeHook': {u'messageVersion': u'1.0',
                                           u'uri': u'arn:aws:lambda:us-east-1:{}:function:botcontrol'.format(
                                               ACCOUNT_ID)},
                             u'type': u'CodeHook'},
    u'name': u'WhatIsOnNow',
    u'sampleUtterances': [u'What is on {when}', u'What can I watch {when}'],
...
who_is_the_speaker_intent = {
    ...
    u'sampleUtterances': [u'Who is the speaker', u'Who is him', u'Who is her'],
    u'slots': [{u'name': u'speaker',
                ...
                u'slotTypeVersion': u'$LATEST',
                u'valueElicitationPrompt': {u'maxAttempts': 2,
                                            u'messages': [{u'content': u'What is the name of the speaker?',
...
whats_the_schedule = {
    ...
    u'sampleUtterances': [u'What is the schedule', u'What is the timetable', u'Timetable', u'Schedule', u'What is the schedule on {when}'],
    u'slots': [{u'name': u'when',
                u'priority': 1,
                u'sampleUtterances': [],
                u'slotConstraint': u'Required',
...
bot = {
    ...
    u'intents': [{u'intentName': u'WhoIsTheSpeaker', u'intentVersion': u'$LATEST'},
                 {u'intentName': u'WhatIsOnNow', u'intentVersion': u'$LATEST'},
...
try:
    lex.delete_intent(name='WhatIsOnNow')
    print 'Deleted intent WhatIsOnNow'
    wait(3)
except ClientError, e:
    if e.response['Error']['Code'] != 'NotFoundException':
        raise
...
lex.put_intent(**what_is_on_intent)
wait(3)
print 'Created WhatIsOnNow intent'

lex.put_intent(**who_is_the_speaker_intent)
wait(3)
print 'Created WhoIsTheSpeaker intent'

lex.put_intent(**whats_the_schedule)
wait(3)
